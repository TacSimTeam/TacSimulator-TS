...
export const MMU_TLB0_HIGH = 0x60;
export const MMU_TLB0_LOW = 0x62;
export const MMU_TLB1_HIGH = 0x64;
export const MMU_TLB1_LOW = 0x66;
export const MMU_TLB2_HIGH = 0x68;
export const MMU_TLB2_LOW = 0x6a;
export const MMU_TLB3_HIGH = 0x6c;
export const MMU_TLB3_LOW = 0x6e;
export const MMU_TLB4_HIGH = 0x70;
export const MMU_TLB4_LOW = 0x72;
export const MMU_TLB5_HIGH = 0x74;
export const MMU_TLB5_LOW = 0x76;
export const MMU_TLB6_HIGH = 0x78;
export const MMU_TLB6_LOW = 0x7a;
export const MMU_TLB7_HIGH = 0x7c;
export const MMU_TLB7_LOW = 0x7e;

export const MMU_TLB8_HIGH = 0x80;
export const MMU_TLB8_LOW = 0x82;
export const MMU_TLB9_HIGH = 0x84;
export const MMU_TLB9_LOW = 0x86;
export const MMU_TLB10_HIGH = 0x88;
export const MMU_TLB10_LOW = 0x8a;
export const MMU_TLB11_HIGH = 0x8c;
export const MMU_TLB11_LOW = 0x8e;
export const MMU_TLB12_HIGH = 0x90;
export const MMU_TLB12_LOW = 0x92;
export const MMU_TLB13_HIGH = 0x94;
export const MMU_TLB13_LOW = 0x96;
export const MMU_TLB14_HIGH = 0x98;
export const MMU_TLB14_LOW = 0x9a;
export const MMU_TLB15_HIGH = 0x9c;
export const MMU_TLB15_LOW = 0x9e;
